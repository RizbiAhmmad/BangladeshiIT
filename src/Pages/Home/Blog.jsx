...
export default function Blog() {
  return (
    <section className="bg-white py-20 px-4" id="blogs">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-10">
          <button className="bg-orange-500 hover:bg-orange-600 text-white text-sm px-6 py-2 rounded-full font-medium transition">
            See All
          </button>
        </div>
      </div>
